...
- 무더위쉼터: 재난안전데이터 공유 플랫폼 API 연결, 실패 시 mockData 사용
...
- 무더위쉼터 API 실패 또는 빈 응답: mockShelters 사용
- 지도 SDK 미연결: 카카오맵 검색 링크 사용

## 다음 작업 후보

1. 무더위쉼터 운영시간/개방여부를 추천 사유에 더 자세히 반영
2. 쉼터 API 호출 결과 캐싱 적용
