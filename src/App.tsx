...
const hwaseongLocationCenters: Record<string, LocationCenter> = {
  ...
  "병점구": { label: "병점구 중심", lat: 37.206, lng: 127.0335 },
  "효행구": { label: "효행구 중심", lat: 37.2203, lng: 126.9498 },
  "만세구": { label: "만세구 중심", lat: 37.1318, lng: 126.9209 },
  ...
  "새솔동": { label: "새솔동 중심", lat: 37.2816, lng: 126.8184 },
};
